...
export function fetchMock(testerName) {
    return new Promise ((resolve) => {
        if (testerName === 'all') resolve(data);

        resolve(data.filter(tester => tester.firstName.toLowerCase().indexOf(testerName.toLowerCase()) > -1));
    });
}